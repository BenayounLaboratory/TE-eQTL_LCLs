...
snps <- load_eQTL_genotypes(expression_file = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_INT_All_Genes_TEs.txt",
...
Single_Matrix_eQTL(is.perm = FALSE,
                   ...
                   R_obj = F, 
                   output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/',
                   R_object_filename = 'L1_subfamily_trans_EUR')
...
Single_Matrix_eQTL(is.perm = FALSE,
                     ...
                     expression_file = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_INT_Only_Genes.txt",
                     gene = NULL,
                     SNP_file = NULL,
                     snps = snps,
                     covariates_file = NULL,
                     R_obj = F, 
                     output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/',
                     R_object_filename = 'Gene_cis_EUR')
...
Permuted_eQTLs(permutations_file = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/MatrixeQTL_Additional_Input_Files/Input_Permutations_Both_Sexes_EUR.txt',
               ...
               snps = snps,
               covariates_file = NULL,
               output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/Gene_cis_EUR_Permutations/',
               R_object_filename = 'Gene_cis_EUR')
...
#                    output_file_tra = NULL,
#                    pvOutputThreshold_tra = 1e-2,
#                    expression_file = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_INT_Only_Alu.txt",
#                    gene = NULL,
#                    SNP_file = NULL,
#                    snps = snps,
#                    covariates_file = NULL,
#                    R_obj = F,
#                    output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/',
#                    R_object_filename = 'Alu_subfamily_trans_EUR')
# 
# # PERMUTATIONS: Alu trans-eQTLs
# Permuted_eQTLs(permutations_file = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/MatrixeQTL_Additional_Input_Files/Input_Permutations_Both_Sexes_EUR.txt',
#                specific_permutations = 1:20,
#                output_file_cis = NULL,
#                snps_pos = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/1_Prepare_Genotype_Data/SNV_Genotypes/Plink_EUR_Genotypes/RESOURCE_SNP_info_EUR.txt",
...
#                snps = snps,
#                covariates_file = NULL,
#                output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/Alu_subfamily_trans_EUR_Permutations/',
#                R_object_filename = 'Alu_subfamily_trans')
