...
# L1 trans-eQTLs (accounting for PEER factors)
Single_Matrix_eQTL(is.perm = FALSE,
                   output_file_cis = NULL,
                   snps_pos = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/1_Prepare_Genotype_Data/SNV_Genotypes/Plink_EUR_Genotypes/RESOURCE_SNP_info_EUR.txt",
                   gene_pos = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/MatrixeQTL_Additional_Input_Files/ENSEMBL_GENE_POSITIONS_EUR.txt",
                   ...
                   output_file_tra = NULL,
                   pvOutputThreshold_tra = 1e-2,
                   expression_file = "/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_with_PEER/All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_PEER_INT_Only_L1.txt",
                   gene = NULL,
                   SNP_file = NULL,
                   snps = snps,
                   covariates_file = NULL,
                   R_obj = F, 
                   output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/',
                   R_object_filename = 'L1_subfamily_trans_with_PEER_EUR')
