...
# # EUR Alu trans-eQTL
# empirical_summary_stats <- empiricalFDR_to_pval(data.file = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/Alu_subfamily_trans_EUR.rds', 
#                                                 null_data.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/Alu_subfamily_trans_EUR_Permutations/', 
#                                                 eQTL_type = 'trans', 
#                                                 arbitrary_pval = 1e-7, 
#                                                 empirical_FDR_target = empirical.FDR.threshold)
# 
#     # Print out the results
#     empirical_summary_stats # 8.315168e-09 4.523810e-02 9.500000e-01 2.100000e+01
#     
#     # Add results to the df
#     if (!is.null(empirical_summary_stats)) {
#         all.empirical.data['EUR_Alu_trans', ] <- empirical_summary_stats
#     }      
...
# (NOT INCLUDED IN THE FINAL ANALYSIS) EXTRACT SIGNIFICANT SNPS : EUR Alu trans eQTL

# # Read eQTL results. Only keep stats.
# eQTL.stats <- readRDS('/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/5_Scan_for_eQTLs/Raw_eQTL_Results/Alu_subfamily_trans_EUR.rds')
# eQTL.stats <- eQTL.stats$all$eqtls
#   
# # Extract pvalue corresponding to user-defined FDR
# BH.pval_threshold <- max(eQTL.stats[eQTL.stats$FDR < BH.FDR.threshold, 'pvalue']) 
# BH.pval_threshold # 1.579182e-09
# 
# # Define empirical FDR pvalue
# empirical.pval_threshold <- empirical.thresholds[c('EUR_Alu_trans'), c('P_threshold')]
# 
# # Run function to extract significant snps
# Extract_sig_snps_from_matrixEQTL(output_location = output.dir, 
#                                  eQTL_stats_df = eQTL.stats, 
#                                  vector_of_significance_thresholds = c(BH.pval_threshold, empirical.pval_threshold), 
#                                  snp_info_df = all_snp_positions.EUR,
#                                  output.file.label = c('Alu_trans_eQTLs_SIGNIFICANT_EUR_'),
#                                  save_rsid_list = c('no'))
