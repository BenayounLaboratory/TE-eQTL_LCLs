...
dir.output <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/'
...
count_Table.dir.YRI <- c("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/3_Read_Counting/Counts_YRI/")
count_Table.dir.EUR <- c("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/3_Read_Counting/Counts_EUR/")
...
gene_TE_counts.YRI <- cleanup_and_filter_counts(count_data = gene_TE_counts_raw_YRI, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 78/86) 
gene_TE_counts.EUR <- cleanup_and_filter_counts(count_data = gene_TE_counts_raw_EUR, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 323/358) 
...
gene_TE_counts.YRI <- as.matrix(read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_YRI_86_filtered.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t'))
gene_TE_counts.EUR <- as.matrix(read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_EUR_358_filtered.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t'))
...
# Load VST dat
VST.YRI <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_YRI_86_filtered_VST.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
...
write.table(batch_corr_YRI, file = paste(dir.output, 'All_counts_YRI_86_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV', '.txt', sep =""), sep = "\t", row.names = T, col.names = NA, quote = F)
write.table(batch_corr_EUR, file = paste(dir.output, 'All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV', '.txt', sep =""), sep = "\t", row.names = T, col.names = NA, quote = F)
...
batch_corr_YRI <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_YRI_86_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
batch_corr_EUR <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
...
Split_and_save_expression(expression_df = INT.vst.regressed.YRI, 
                          output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/', 
                          output_file_prefix = 'All_counts_YRI_86_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_INT_', 
                          gene_prefix = 'ENSG', 
                          TE_groups = 'Subfamily')

Split_and_save_expression(expression_df = INT.vst.regressed.EUR, 
                          output.dir = '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1_eQTL_Analysis/4_Prepare_RNASeq/Processed_counts_eQTL/', 
                          output_file_prefix = 'All_counts_EUR_358_filtered_VST_BatchesRemoved_lab_ancestry_PCs_sex_TE_copies_EBV_INT_', 
                          gene_prefix = 'ENSG', 
                          TE_groups = 'Subfamily')
