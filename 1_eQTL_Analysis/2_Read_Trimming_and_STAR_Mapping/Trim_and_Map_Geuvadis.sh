...
star_indices="/Users/juanb/Documents/Bioinformatic_Tools/STAR_genome_indices/homo_sapiens_gencode_v33_plus_EBV/indices/"

# Define the extensions for the F and R paired end files
R1_extension_Trim="_1.fastq.gz"
R2_extension_Trim="_2.fastq.gz"
