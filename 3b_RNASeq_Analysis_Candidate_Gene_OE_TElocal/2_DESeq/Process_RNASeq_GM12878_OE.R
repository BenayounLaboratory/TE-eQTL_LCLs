...
dir.output <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/2_DESeq/Processed_counts_GM12878_OE/'

# Define the directory with the counts tables and collect individual file paths in a list.
count_Table.dir <- c("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/1_Read_counting/TElocal_Counts_GM12878_Candidate_OE/")
...
misc.feature.indices <- which(!grepl('pcDNA', gene_TE_counts_raw$gene.TE))
...
counts_filtered.IL16 <- prefilter_TE_aggregation(gene_TE_counts = gene_TE_counts_raw[, treatment1], 
                                                     aggregate_all = FALSE, 
...
counts_filtered.STARD5 <- prefilter_TE_aggregation(gene_TE_counts = gene_TE_counts_raw[, treatment2], 
                                                     aggregate_all = FALSE, 
                                                     intergenic_nearby_repeats = repeats.intergenic.nearby, 
                                                     intergenic_distal_repeats = repeats.intergenic.distal, 
                                                     intronic_repeats = repeats.intronic, 
...
counts_filtered.HSD17B12 <- prefilter_TE_aggregation(gene_TE_counts = gene_TE_counts_raw[, treatment3], 
                                                     aggregate_all = FALSE, 
                                                     intergenic_nearby_repeats = repeats.intergenic.nearby, 
                                                     intergenic_distal_repeats = repeats.intergenic.distal, 
                                                     intronic_repeats = repeats.intronic, 
...
counts_filtered.RNF5 <- prefilter_TE_aggregation(gene_TE_counts = gene_TE_counts_raw[, treatment4], 
                                                     aggregate_all = FALSE, 
                                                     intergenic_nearby_repeats = repeats.intergenic.nearby, 
                                                     intergenic_distal_repeats = repeats.intergenic.distal, 
                                                     intronic_repeats = repeats.intronic, 
...
counts_filtered.IL16 <- cleanup_and_filter_counts(count_data = counts_filtered.IL16, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 4/8)
counts_filtered.STARD5 <- cleanup_and_filter_counts(count_data = counts_filtered.STARD5, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 4/8)
counts_filtered.HSD17B12 <- cleanup_and_filter_counts(count_data = counts_filtered.HSD17B12, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 4/8)
counts_filtered.RNF5 <- cleanup_and_filter_counts(count_data = counts_filtered.RNF5, filter = TRUE, min_counts_per_sample = 10, fraction_of_samples = 4/8)


    # Save counts files.
    write.table(counts_filtered.IL16, file = paste(dir.output, "TElocal_counts_filtered_IL16", ".txt", sep=""), row.names = TRUE, col.names = NA, sep = "\t", na = "NA", quote = FALSE)
    write.table(counts_filtered.STARD5, file = paste(dir.output, "TElocal_counts_filtered_STARD5", ".txt", sep=""), row.names = TRUE, col.names = NA, sep = "\t", na = "NA", quote = FALSE)
    write.table(counts_filtered.HSD17B12, file = paste(dir.output, "TElocal_counts_filtered_HSD17B12", ".txt", sep=""), row.names = TRUE, col.names = NA, sep = "\t", na = "NA", quote = FALSE)
    write.table(counts_filtered.RNF5, file = paste(dir.output, "TElocal_counts_filtered_RNF5", ".txt", sep=""), row.names = TRUE, col.names = NA, sep = "\t", na = "NA", quote = FALSE)
...
counts.output.dir <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/2_DESeq/Processed_counts_GM12878_OE/'
DESeq.output.dir <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/2_DESeq/DESeq_Results_GM12878_OE/'
MDS.output.dir <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/2_DESeq/MDS_PCA_GM12878_OE/'
...
# Save session info    
dir.session_info <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3b_RNASeq_Analysis_Candidate_Gene_OE_TElocal/2_DESeq/Session_Info/'
