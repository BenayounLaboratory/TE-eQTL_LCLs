...
# Section 3: MISC GENE EXPRESSION PLOTS ------------------------------------------------------------------------------------------------------------------------
...
# Load DESeq results
DESeq.IL16 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/DESeq_Results_GM12878_OE/All_Genes_IL16.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
DESeq.STARD5 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/DESeq_Results_GM12878_OE/All_Genes_STARD5.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
DESeq.HSD17B12 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/DESeq_Results_GM12878_OE/All_Genes_HSD17B12.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
DESeq.RNF5 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/DESeq_Results_GM12878_OE/All_Genes_RNF5.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')

# Load VST Expression
VST.IL16 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/Processed_counts_GM12878_OE/All_counts_filtered_IL16_VST.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
VST.STARD5 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/Processed_counts_GM12878_OE/All_counts_filtered_STARD5_VST.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
VST.HSD17B12 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/Processed_counts_GM12878_OE/All_counts_filtered_HSD17B12_VST.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
VST.RNF5 <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/3_DESeq/Processed_counts_GM12878_OE/All_counts_filtered_RNF5_VST.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')

    
    

# Generate EBV expression box plots for TEs in eQTL
    
    # IL16 OE
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'EBV_gene', 
                    target_gene_symbol = 'EBV_vs_IL16_OE', 
                    VST.data = as.matrix(VST.IL16), 
                    Sig.DESeq.Res = DESeq.IL16,
                    control_label = 'Empty', 
                    control_n = '4', 
                    treatment_label = 'IL16 OE', 
                    treatment_n = '4',
    ...
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'EBV_gene', 
                    target_gene_symbol = 'EBV_vs_STARD5_OE', 
                    VST.data = as.matrix(VST.STARD5), 
                    Sig.DESeq.Res = DESeq.STARD5,
                    control_label = 'Empty', 
                    control_n = '4', 
                    treatment_label = 'STARD5 OE', 
                    treatment_n = '4',
    ...
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'EBV_gene', 
                    target_gene_symbol = 'EBV_vs_HSD17B12_OE', 
                    VST.data = as.matrix(VST.HSD17B12), 
                    Sig.DESeq.Res = DESeq.HSD17B12,
                    control_label = 'Empty', 
                    control_n = '4', 
                    treatment_label = 'HSD17B12 OE', 
                    treatment_n = '4',
    ...
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'EBV_gene', 
                    target_gene_symbol = 'EBV_vs_RNF5_OE', 
                    VST.data = as.matrix(VST.RNF5), 
                    Sig.DESeq.Res = DESeq.RNF5,
                    control_label = 'Empty', 
                    control_n = '4', 
                    treatment_label = 'RNF5 OE', 
                    treatment_n = '4',
...
# Generate expression box plots for TEs in eQTL
    
    # L1P4a, IL16 OE
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'L1P4a:L1:LINE', 
                    target_gene_symbol = 'L1P4a_vs_IL16', 
                    VST.data = as.matrix(VST.IL16), 
                    Sig.DESeq.Res = DESeq.IL16,
                    control_label = 'Empty', 
                    control_n = '4', 
    ...
    Plot_Expression(output.dir = DESeq.output.dir, 
                    target_gene_Ensembl_name = 'L1P4a:L1:LINE', 
                    target_gene_symbol = 'L1P4a_vs_STARD5', 
                    VST.data = as.matrix(VST.STARD5), 
                    Sig.DESeq.Res = DESeq.STARD5,
                    control_label = 'Empty', 
                    control_n = '4', 
