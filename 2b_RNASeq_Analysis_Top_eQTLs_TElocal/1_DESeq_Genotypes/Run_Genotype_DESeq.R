...
dir.output.DESeq <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/2b_RNASeq_Analysis_Top_eQTLs_TElocal/1_DESeq_Genotypes/DESeq_Results/'  
...
counts.YRI <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1b_eQTL_Analysis_TElocal/2_Prepare_RNASeq/Processed_counts_eQTL/TElocal_counts_YRI_86_filtered_aggregate_split.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
counts.EUR <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/1b_eQTL_Analysis_TElocal/2_Prepare_RNASeq/Processed_counts_eQTL/TElocal_counts_EUR_358_filtered_aggregate_split.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
...
top.snps.EUR <- c('rs11635336', 'rs9271894', 'rs1061810', 'rs112581165', 'rs72691418', 'rs9270493', 'rs1361387') # NOTE: rs9270493 is for RNF5 and rs1361387 is for ZSCAN26
...
Run_DESeq(all_covariates = covariates_table.EUR, 
          SNV_RsID = c('rs1361387'), 
          target_population = c('EUR'), 
          counts_df = counts.EUR, 
          my.output.dir = dir.output.DESeq, 
          my.output.prefix = c('EUR_rs1361387'))   
...
# Save session info    
dir.session_info <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/2b_RNASeq_Analysis_Top_eQTLs_TElocal/1_DESeq_Genotypes/Session_Info/'
