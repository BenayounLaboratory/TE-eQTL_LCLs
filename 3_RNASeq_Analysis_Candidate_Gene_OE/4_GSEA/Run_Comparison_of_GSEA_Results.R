...
# COMPARE GSEA RESULTS (GM12878 IL16 OE vs STARD5 OE) 

# GSEA directory for output files
my.output.dir <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/3_RNASeq_Analysis_Candidate_Gene_OE/4_GSEA/Results_Overlap/GM12878_IL16_and_STARD5/'
...
#                                      result.two = TFT.OE.STARD5@result,
#                                      label.one = my.label.one,
#                                      label.two = my.label.two,
#                                      number_to_plot = 10)
...
#                                      result.two = miRDB.OE.STARD5@result,
#                                      label.one = my.label.one,
#                                      label.two = my.label.two,
#                                      number_to_plot = 10)
...
# Hallmark
pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_Hallmark", ".pdf", sep=""), width = 9, height = 5)
...
# Reactome
pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_Reactome", ".pdf", sep=""), width = 9, height = 5)
...
# GOBP  
pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_GOBP", ".pdf", sep=""), width = 9, height = 5)
...
# # TFT
# pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_TFT", ".pdf", sep=""), width = 9, height = 5)
# 
...
# 
# # miRDB
# pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_miRDB", ".pdf", sep=""), width = 9, height = 5)
# 
...
# TE families  
pdf(paste(my.output.dir, "GSEA_BubblePlot_GM12878_OE_Overlap_TE_families", ".pdf", sep=""), width = 9, height = 5)
...
sink(file = paste(dir.session_info, "Session_Info_GSEA_Overlapping_GM12878_OE.txt", sep =""))
sessionInfo()
sink()      
