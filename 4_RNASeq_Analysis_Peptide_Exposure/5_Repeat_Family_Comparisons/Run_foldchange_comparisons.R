...
my.output.dir <- '/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/4_RNASeq_Analysis_Peptide_Exposure/5_Repeat_Family_Comparisons/Plots/'
...
# Load rhIL16 T24 (Condition 1) DESeq results
DESeq.res <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/4_RNASeq_Analysis_Peptide_Exposure/3_DESeq/DESeq_Results_GM12878_rIL16/rIL16_T24_vs_T0_All_Genes.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
...
# Load rhIL16 T48 (Condition 2) DESeq results
DESeq.res <- read.csv("/Users/juanb/Desktop/2023_TE_eQTL_Juan/Code/4_RNASeq_Analysis_Peptide_Exposure/3_DESeq/DESeq_Results_GM12878_rIL16/rIL16_T48_vs_T0_All_Genes.txt", header = T, row.names = 1, stringsAsFactors = F, sep = '\t')
...
# IL16 OE
pdf(paste(my.output.dir, "Boxplot_Repeat_log2FC_rhIL16_T24", ".pdf", sep=""), width = 3.25, height = 4)
...
pdf(paste(my.output.dir, "Boxplot_Repeat_log2FC_rhIL16_T48", ".pdf", sep=""), width = 3.25, height = 4)
